      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              // typeprofilestatedefaultJCV (1:225)
            ...
            Container(
              // typeproductsstatedefaultRpq (1:708)
            ...
            Container(
              // typestatsstatedefaultBhX (1:709)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 18*fem, 3*fem),
              width: 24*fem,
              height: 24*fem,
              child: Image.asset(
            ...
            Container(
              // typehidestatedefaultLyj (1:1097)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 18*fem, 3*fem),
              width: 19*fem,
              height: 14*fem,
              child: Image.asset(
            ...
            Container(
              // typeshowstatedefaultwid (1:1100)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 18*fem, 3*fem),
              width: 19*fem,
              height: 16*fem,
              child: Image.asset(
            ...
            Container(
              // typeheartstatedefaultwc9 (1:824)
            ...
            Container(
              // typeheartstateenabledtvh (1:1334)
            ...
            Container(
              // typeprivacystatedefaultr8m (1:4335)
            ...
            Container(
              // typenotificationsstatedefaultz (1:4334)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 18*fem, 0.2*fem),
              width: 40*fem,
              height: 38.8*fem,
              child: Image.asset(
            ...
            Container(
              // typesearchhistorystatedefaulti (1:4333)
            ...
            Container(
              // typelogoutstatedefaultgJ9 (1:4336)
