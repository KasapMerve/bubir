        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                // designsystemtypographyhPB (1:4518)
              ...
              Container(
                // designsystemtypographyx3X (1:4526)
                padding: EdgeInsets.fromLTRB(0*fem, 16*fem, 0*fem, 15*fem),
                width: double.infinity,
                decoration: BoxDecoration (
                  borderRadius: BorderRadius.only (
              ...
              Container(
                // designsystemtypographyQfX (1:4534)
                padding: EdgeInsets.fromLTRB(0*fem, 16*fem, 0*fem, 16*fem),
                width: double.infinity,
                decoration: BoxDecoration (
                  borderRadius: BorderRadius.only (
              ...
              Container(
                // designsystemtypographytpu (1:4542)
                padding: EdgeInsets.fromLTRB(0*fem, 16*fem, 0*fem, 16*fem),
                width: double.infinity,
                decoration: BoxDecoration (
                  borderRadius: BorderRadius.only (
              ...
              Container(
                // designsystemtypographybCq (1:4550)
                padding: EdgeInsets.fromLTRB(0*fem, 16*fem, 0*fem, 16*fem),
                width: double.infinity,
                decoration: BoxDecoration (
                  borderRadius: BorderRadius.only (
              ...
              Container(
                // designsystemtypographyMqX (1:4558)
                padding: EdgeInsets.fromLTRB(0*fem, 16*fem, 0*fem, 16*fem),
                width: double.infinity,
                decoration: BoxDecoration (
                  borderRadius: BorderRadius.only (
